...
namespace IQGlyQ.Objects
{
    public class IsotopeParameters
    {
        ...
        public IsotopeParameters(int numberOfPeaksToLeftForPenalty, EnumerationIsotopePenaltyMode mode, EnumerationIsotopicProfileMode isotopeProfileMode, ITheorFeatureGenerator theorFeatureGen, double fractionalIntensityCuttoffForTheoretical, double cutOffArea)
        {
