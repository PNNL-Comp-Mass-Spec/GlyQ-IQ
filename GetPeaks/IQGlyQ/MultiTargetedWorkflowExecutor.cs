...
namespace IQGlyQ
{
    public abstract class MultiTargetedWorkflowExecutor : WorkflowBase
    {
        ...
        protected MultiTargetedResultRepository ResultRepository;
        ...
        #region Constructors
        public MultiTargetedWorkflowExecutor(WorkflowExecutorBaseParameters parameters, string datasetPath, BackgroundWorker backgroundWorker = null)
        {
            ...
            ResultRepository = new MultiTargetedResultRepository();
            InitializeWorkflow();
        }

        public MultiTargetedWorkflowExecutor(WorkflowExecutorBaseParameters workflowExecutorParameters, TargetedWorkflow targetedWorkflow,string datasetPath, BackgroundWorker backgroundWorker = null )
        {
            this.DatasetPath = datasetPath;
		...
		public MultiTargetedWorkflowExecutor(WorkflowExecutorBaseParameters workflowExecutorParameters, WorkflowParameters workflowParameters, string datasetPath, BackgroundWorker backgroundWorker = null)
		{
			this.DatasetPath = datasetPath;
        ...
        public MultiTargetedWorkflowExecutor(WorkflowExecutorBaseParameters parameters, Run run, BackgroundWorker backgroundWorker = null)
        {
            Run = run;
        ...
        public override void InitializeWorkflow()
        {
            ...
            if (ExecutorParameters.TargetType == DeconTools.Workflows.Backend.Globals.TargetType.LcmsFeature)
            {
        ...
        public void ProcessDataset()
        {
            ...
            foreach (var massTag in this.Targets.TargetList)
            {
                ...
                try
                {
                    ...
                    //TODO add multi result loop here
        ...
        protected TargetCollection CreateTargets(DeconTools.Workflows.Backend.Globals.TargetType targetType, string targetFilePath)
        {
            if (string.IsNullOrEmpty(targetFilePath)) return null;

            switch (targetType)
            {
                case DeconTools.Workflows.Backend.Globals.TargetType.LcmsFeature:
                    return GetLcmsFeatureTargets(targetFilePath);

                case DeconTools.Workflows.Backend.Globals.TargetType.DatabaseTarget:
