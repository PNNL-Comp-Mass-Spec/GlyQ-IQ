...
namespace IQGlyQ.UnitTesting
{
    ...
    class ModuleTesting
    {
        private string massSpecFilePath = @"E:\PNNL Data\2012_09_05 SPIN Q-TOF\Gly08_SQTOF_SL26_100_C2_13_HPIF30Torr_LPRF96_T160_18Sept12.d";//work
        ...
        public void CreateCorrelationObjectAndtestConstancty()
        {
            ...
            DeconTools.Backend.XYData deconBufferedChromatogram = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, xValue, ScanBoundsInfoMaxMin);
            ...
            DeconTools.Backend.XYData upfrontEIC = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, possibleFragmentTarget.TheorIsotopicProfile, possibleFragmentTarget.ElutionTimeTheor);
        ...
        public void GenerateCandidateList1790()
        {
            ...
            iQresult.Target.TheorIsotopicProfile = Utiliites.TherortIsotopeicProfileWrapperLowLevel(ref theorFeatureGenerator,"C64H110N2O51", 2);//8200
            possibleFragmentPeakQuality.IsotopicProfile = iQresult.Target.TheorIsotopicProfile;
            //possibleFragmentPeakQuality.IsotopicProfile = _theorFeatureGen.GenerateTheorProfile(possibleFragmentTarget.EmpiricalFormula,2);
            possibleFragmentPeakQuality.IsotopicProfile = Utiliites.GenerateCombinedIsotopicProfile(iQresult, 1, 1);
        ...
        public void TestChromatogram()
        {
            ...
            result.Target.TheorIsotopicProfile = Utiliites.TherortIsotopeicProfileWrapperLowLevel(ref TheorFeatureGen, result.Target.EmpiricalFormula, result.Target.ChargeState);
            ...
            ChromPeakAnalyzer ChromPeakAnalyzer = new DeconTools.Workflows.Backend.Core.ChromPeakSelection.ChromPeakAnalyzer(_workflowParameters);
            ...
            //TEST CODE
            DeconTools.Backend.XYData unWrappedDecon = _workflowParameters.LCParameters.Engine_PeakChromGenerator.GenerateChromatogram(runIn, result.Target.TheorIsotopicProfile, result.Target.ElutionTimeTheor);
            ...
            //decon
            DeconTools.Backend.ProcessingTasks.Smoothers.SavitzkyGolaySmoother ChromSmootherDecon =
        ...
        public void TestChromatogramPeaks()
        {
            ...
            DeconTools.Backend.ProcessingTasks.Smoothers.SavitzkyGolaySmoother ChromSmoother = new SavitzkyGolaySmoother(_workflowParameters.LCParameters.ParametersSavitskyGolay.PointsForSmoothing,_workflowParameters.LCParameters.ParametersSavitskyGolay.PolynomialOrder,_workflowParameters.LCParameters.ParametersSavitskyGolay.AllowNegativeValues);
        ...
        public void TestInput()
        {
            ...
            Assert.AreEqual(DeconTools.Backend.Globals.LabellingType.Deuterium, _workflowParameters.IsotopeProfileType);
            Assert.AreEqual(DeconTools.Backend.Globals.IsotopicProfileType.LABELLED, _workflowParameters.LabelingTypeSwitch);
            ...
            Assert.AreEqual(SummingModeEnum.SUMMINGMODE_STATIC, _workflowParameters.SummingMode);
            Assert.AreEqual(DeconTools.Workflows.Backend.Globals.TargetedWorkflowTypes.Deuterated, _workflowParameters.WorkflowType);
            ...
            Assert.AreEqual(1661, targetResult.TargetFragment.ScanLCTarget);
        ...
        public void TestPeakCentroiding()
        {
            ...
            List<XYData> omicsPeaks = GetPeaks_DLL.Functions.ConvertXYData.DeconXYDataToOmicsXYData(iQresult.IqResultDetail.MassSpectrum);
        ...
        public void TestPeakCentroidingSpeedOmicsDecon()
        {
            ...
            {
                ScanSet scanSet = runIn.ScanSetCollection.ScanSetList[i];
                DeconTools.Backend.XYData deconMassSpecta = msParameters.Engine_msGenerator.GenerateMS(runIn, scanSet);
                //int scan = i;
                //scan = 135;
        ...
        public void TestProcessorLcAt2Levels()
        {
            ...
            DeconTools.Backend.XYData bufferedDeconChromatogram = _lcProcessor.GenerateBufferedChromatogramByPoint(runIn, targetResult.ScanBoundsInfo, mass);
            ...
            DeconTools.Backend.XYData deconChromatogram = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, mass, targetResult.ScanBoundsInfo);
        ...
        public void TestProcessorLc()
        {
            ...
            DeconTools.Backend.XYData deconChromatogram = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, mass, ScanBoundsInfoMaxMin);
            ...
            DeconTools.Backend.XYData deconChromatogramTopPeak = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, targetResult.TargetFragment.TheorIsotopicProfile, targetResult.ScanBoundsInfo, chromTollerence, Globals.ToleranceUnit.PPM, _workflowParameters.LCParameters.Engine_PeakChromGenerator);
            ...
            DeconTools.Backend.XYData deconChromatogramTopN = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, targetResult.TargetFragment.TheorIsotopicProfile, targetResult.ScanBoundsInfo, chromTollerence, Globals.ToleranceUnit.PPM, _workflowParameters.LCParameters.Engine_PeakChromGenerator);
            ...
            DeconTools.Backend.XYData deconChromatogramTop1 = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, targetResult.TargetFragment.TheorIsotopicProfile, targetResult.ScanBoundsInfo, chromTollerence, Globals.ToleranceUnit.PPM, _workflowParameters.LCParameters.Engine_PeakChromGenerator);
            ...
            DeconTools.Backend.XYData deconBufferedChromatogramPoint =_lcProcessor.GenerateBufferedChromatogramByPoint(runIn, targetResult.ScanBoundsInfo, mass);
            ...
            DeconTools.Backend.XYData deconBufferedChromatogram = _lcProcessor.GenerateBufferedChromatogramByPoint(runIn, targetResult.ScanBoundsInfo, mass);
           ...
           // Assert.AreEqual(fullEIC.Count, 70);
            ...
            Assert.AreEqual(LCProcessorOnChromatogramLevelXYPeaksClipped.Count, 4);//4
            ...
            Assert.AreEqual(LCProcessorOnSmoothSectionPeaksFiltered.Count, 4);//4
            ...
            for (int i = 0; i < iterator; i++)
            {
                DeconTools.Backend.XYData deconBufferedChromatogramInfinity = _lcProcessor.GenerateBufferedChromatogramByPoint(runIn, targetResult.ScanBoundsInfo, mass);//_workflowParameters.LCParameters.ParametersChromGenerator.ChromToleranceInPPM
        ...
        public void TestProcessTarget()
        {
            ...
            Assert.AreEqual(862.30888177738859d, targetResult.FragmentObservedIsotopeProfile.MonoPeakMZ);
        ...
        public void TestSmoothers()
        {
            ...
            DeconTools.Backend.XYData smoothedResultsPureDecon = deconSmoother.Smooth(iQresult.IqResultDetail.MassSpectrum);
            ...
            {
                DeconTools.Backend.XYData chromatogramDeconProcessedInfinity = deconSmoother.Smooth(iQresult.IqResultDetail.MassSpectrum);
            ...
            {
                DeconTools.Backend.XYData chromatogramDeconProcessed = GetPeaks_DLL.Functions.ConvertXYData.OmicsXYDataToDeconXYData(convertedMassSpectrum);
                DeconTools.Backend.XYData chromatogramDeconProcessedInfinity = deconSmoother.Smooth(chromatogramDeconProcessed);
        ...
        public void TestVerifyByTargetedFeatureFinding()
        {
            ...
            ITheorFeatureGenerator theorFeatureGenerator = _theorFeatureGen;
            possibleFragmentTarget.TheorIsotopicProfile = Utiliites.TherortIsotopeicProfileWrapperLowLevel(ref theorFeatureGenerator, iQresult.Target.EmpiricalFormula, possibleFragmentTarget.ChargeState);

            possibleFragmentTarget.TheorIsotopicProfile = Utiliites.GenerateCombinedIsotopicProfile(iQresult, 1, 1);

            possibleFragmentTarget.TheorIsotopicProfile = Utiliites.Add1DaPointsToIso(possibleFragmentTarget.TheorIsotopicProfile, padZeroes);
            ...
            oneDaltonShiftedTarget.TheorIsotopicProfile = Utiliites.TherortIsotopeicProfileWrapperLowLevel(ref theorFeatureGenerator, iQresult.Target.EmpiricalFormula, possibleFragmentTarget.ChargeState);
            ...
            oneDaltonShiftedTarget.TheorIsotopicProfile = Utiliites.Add1DaPointsToIso(oneDaltonShiftedTarget.TheorIsotopicProfile, padZeroes);
        ...
        private Task _fitScoreCalc { get; set; }
