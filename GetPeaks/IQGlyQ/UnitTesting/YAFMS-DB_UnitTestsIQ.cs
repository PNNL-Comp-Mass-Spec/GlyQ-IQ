...
namespace IQGlyQ.UnitTesting
{
    public class YAFMS_DB_UnitTestsIQ
    {
        ...
        public void TestMassSpecGeneration()
        {
            ...
            DeconTools.Backend.XYData massSpectrum = _msProcessor.DeconMSGeneratorWrapper(runIn, iQresult.LCScanSetSelected);
            ...
            DeconTools.Backend.XYData massSpectrum2 = _msProcessor.DeconMSGeneratorWrapper(runIn, iQresult.LCScanSetSelected);
