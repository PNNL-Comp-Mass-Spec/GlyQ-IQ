...
namespace IQGlyQ.UnitTesting
{
    public class IQ_UnitTests
    {
        ...
        public void findSingleMassTag_test1()
        {
            ...
            parameters.IsotopeProfileType = DeconTools.Backend.Globals.LabellingType.Deuterium;
      ...
      //      string nodeFilePath = @"F:\ScottK\ToPIC\WorkingParameters" + @"\" + sleepFileName;
        ...
        {
            GetPeaks_DLL.DataFIFO.StringLoadTextFileLine reader2 = new StringLoadTextFileLine();
