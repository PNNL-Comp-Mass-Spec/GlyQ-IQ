    ...
    public static class GenerateListOfCandidateParents
    {
        ...
        )
        {
            ...
            foreach (FragmentIQTarget fragment in _workflowParameters.FragmentsIq)
            {
                ...
                targetPlusDifferenceNoCharge.MZTheor = GetPeaks_DLL.Functions.ConvertMonoToMz.Execute(targetPlusDifferenceNoCharge.MonoMassTheor, targetPlusDifferenceNoCharge.ChargeState, MassProton);
                ...
                //targetPlusDifferenceNoCharge.TheorIsotopicProfile = Utiliites.TherortIsotopeicProfileWrapperLowLevel(ref _theorFeatureGen, targetPlusDifferenceNoCharge.EmpiricalFormula, targetPlusDifferenceNoCharge.ChargeState);
                ...
                Utiliites.TherortIsotopeicProfileWrapper(ref _theorFeatureGen, targetPlusDifferenceNoCharge, _workflowParameters.MSParameters.IsoParameters.IsotopeProfileMode, deltaMassCalibrationMz, deltaMassCalibrationMono, toMassCalibrate, penaltyMode);
        ...
        //        chargedTarget.TheorIsotopicProfile = Utiliites.TherortIsotopeicProfileWrapperLowLevel(ref _theorFeatureGen, chargedTarget.EmpiricalFormula, charge);
