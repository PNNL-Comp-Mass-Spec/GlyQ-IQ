...
namespace IQGlyQ
{
   ...
   //     public int NumberOfPeaksToLeftForPenalty { get; set; }
        ...
        {
            //DH labeling
            IsotopeProfileType = DeconTools.Backend.Globals.LabellingType.Deuterium;//default
            //IsotopeProfileType = DeconTools.Backend.Globals.LabellingType.NONE;
            LabelingTypeSwitch = DeconTools.Backend.Globals.IsotopicProfileType.LABELLED;//default
