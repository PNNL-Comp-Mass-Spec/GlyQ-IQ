            ...
            ref ChromatogramCorrelatorBase chromatogramCorrelator, double correlationscorecuttoff, int minimumPointsForOverlap)
        {
            ...
            if (localError == EnumerationError.NoError)
            {
                ...
                if (checkScanRange)
                {
                    ...
                    if (chromeResults.CorrelationDataItems.Count > 0) //this should be true if the correlation returned data
                    {
                        ...
                        if (chromeResults.RSquaredValsAverage > correlationscorecuttoff)
                        {
                            if (chromeResults.CorrelationDataItems[0].CorrelationSlope < 0) //this is anticorrelated
                            {
                                ...
                                Console.WriteLine("#lc notches anti  correlate " + dataToReturn.TargetFragment.ScanLCTarget + "_" + dataToReturn.ParentCharge + " " + -1 * chromeResults.RSquaredValsAverage + Environment.NewLine);
                            ...
                            else
                            {
                                ...
                                Console.WriteLine("#lc notches correlate " + dataToReturn.TargetFragment.ScanLCTarget + "_" + dataToReturn.ParentCharge + " " + chromeResults.RSquaredValsAverage + Environment.NewLine);
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("#lc notches do not correlate " + dataToReturn.TargetFragment.ScanLCTarget + "_" + dataToReturn.ParentCharge + " " + chromeResults.RSquaredValsAverage + Environment.NewLine);
                            dataToReturn.IsAntiCorrelated = false;
                            dataToReturn.IsIntact = true;
                        }
                    ...
                    {
                        Console.WriteLine("#no parent data so it much be intact " + dataToReturn.TargetFragment.ScanLCTarget + "_" + dataToReturn.ParentCharge + " " + chromeResults.RSquaredValsAverage + Environment.NewLine);
                        dataToReturn.IsAntiCorrelated = false;
                        dataToReturn.IsIntact = true;
                    }
