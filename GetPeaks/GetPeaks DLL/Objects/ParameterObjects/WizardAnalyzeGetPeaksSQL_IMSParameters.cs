...
{
    public class WizardAnalyzeGetPeaksSQL_IMSParameters
     {
        ...
        public WizardAnalyzeGetPeaksSQL_IMSParameters(List<string> stringListFromParameterFile)
        {
            ...
            //sql data base input
            FullFeaturesFile = DataFilePath + DataFileName + DataFileIdentifier + @"_LCMSFeatures.txt";
            ...
            JustTheFeatureFileCompleteName = DataFileName + DataFileIdentifier + @"_LCMSFeatures.txt";
