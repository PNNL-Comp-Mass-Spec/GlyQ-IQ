...
{
    public class ElutingPeakOmics:IDisposable
    {
        #region Constructors

        public ElutingPeakOmics()
        {
            PeakList = new List<MSPeakResultOmics>();
        ...
        public List<MSPeakResultOmics> PeakList { get; set; }
...
//        public ScanSet ScanSet { get; set; }
        ...
        public MSPeakResultOmics GetMSPeakResultRepresentative()
        {
