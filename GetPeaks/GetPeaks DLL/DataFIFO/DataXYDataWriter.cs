...
namespace GetPeaks_DLL.DataFIFO
{
    public interface IXYDataWriter
    {
        ...
        int WriteDeconXYDataDeconTools(DeconTools.Backend.XYData XYData, string path);
        int WriteOmicsProcesedPeakData(List<PNNLOmics.Data.ProcessedPeak> peakDataList, string path);
    }
    ...
    public class DataXYDataWriter : IXYDataWriter
    {
        ...
        public int WriteOmicsProcesedPeakData(List<PNNLOmics.Data.ProcessedPeak> peakDataList, string path)
        {
            int isSuccess = 0;//nonsucessful outcome.  Still to be determined
        ...
        public int WriteDeconXYDataDeconTools(DeconTools.Backend.XYData XYData, string path)
        {
            int isSuccess = 0;//nonsucessful outcome.  Still to be determined
