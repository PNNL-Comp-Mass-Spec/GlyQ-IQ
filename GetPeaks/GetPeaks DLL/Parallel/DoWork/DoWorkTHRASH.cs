...
namespace GetPeaks_DLL.Parallel.DoWork
{
    public static class DoWorkTHRASH
    {
        ...
        private static ParametersPeakDetection PeakDetectionParametersConvert(ParametersTHRASH currentParameters)
        {
            ...
            peakDetectionParameters.DeconToolsPeakDetection.MsPeakDetectorPeakToBackground = currentParameters.PeakDetectionMultiParameters.DeconToolsPeakDetection.MsPeakDetectorPeakToBackground;
            peakDetectionParameters.DeconToolsPeakDetection.PeakFitType = currentParameters.PeakDetectionMultiParameters.DeconToolsPeakDetection.PeakFitType;
            peakDetectionParameters.DeconToolsPeakDetection.SignalToNoiseRatio = currentParameters.PeakDetectionMultiParameters.DeconToolsPeakDetection.SignalToNoiseRatio;
            peakDetectionParameters.HammerParameters = currentParameters.PeakDetectionMultiParameters.HammerParameters;
            ...
            peakDetectionParameters.PeakDetectionMethod = currentParameters.PeakDetectionMultiParameters.PeakDetectionMethod;
            ...
            peakDetectionParameters.isDataThresholdedDecon = currentParameters.PeakDetectionMultiParameters.isDataThresholdedDecon;
