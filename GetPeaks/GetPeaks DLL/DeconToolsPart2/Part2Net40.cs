...
namespace GetPeaks_DLL.DeconToolsPart2
{
    public class Part2Net40
    {
        ...
        public int MultiThreadDiscovery(InputOutputFileName newFile, List<ElutingPeakOmics> discoveredPeaks, List<string> errorLog)
        {
            ...
            //TODO slash out paralell for testing
            System.Threading.Tasks.Parallel.ForEach(discoveredPeaks, new ParallelOptions { MaxDegreeOfParallelism = maxNumberOfThreadsToUse }, ePeak =>
            {
