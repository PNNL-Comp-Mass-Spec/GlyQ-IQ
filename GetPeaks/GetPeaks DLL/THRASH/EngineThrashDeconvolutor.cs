...
namespace GetPeaks_DLL.THRASH
{
    public class EngineThrashDeconvolutor:ParalellEngine//this is the latest and greatest
    {
        /// <summary>
        ...
        public EngineThrashDeconvolutor(string parameterFileName)
        {
            ...
            ParametersTHRASH transformerParameterSetup = new ParametersTHRASH();
            //var parameters = new OldDecon2LSParameters();
            // parameters.Load(transformerParameterSetup.DeconToolsParameterFileName);

            var parameters = new DeconToolsParameters();
            parameters.LoadFromOldDeconToolsParameterFile(transformerParameterSetup.DeconToolsParameterFileName);
        ...
        public EngineThrashDeconvolutor(ParametersTHRASH transformerParameterSetup, Object databaseLock, int engineNumber)
        {
            ...
            ThrashParameters tempThrashParameters = parameters.ThrashParameters;
            ConvertOldThrashParametersToNew.OldToNew(transformerParameterSetup, ref tempThrashParameters);

            //end new

            parameters.PeakDetectorParameters.PeakToBackgroundRatio = transformerParameterSetup.PeakDetectionMultiParameters.DeconToolsPeakDetection.MsPeakDetectorPeakToBackground;
            //parameters.PeakProcessorParameters.PeakBackgroundRatio = transformerParameterSetup.PeakDetectionMultiParameters.DeconToolsPeakDetection.MsPeakDetectorPeakToBackground;
            parameters.ParameterFilename = transformerParameterSetup.DeconToolsParameterFileName;
        ...
        public static void SetupScanSet(bool multithreadedHardDriveMode, ParametersTHRASH thrashParameters, EngineStationTHRASH engineStation, EngineThrashDeconvolutor ThrashEngine)
        {
            ...
            if (multithreadedHardDriveMode == true)
            {
                ...
                try
                {
                    ThrashEngine.Run.ScanSetCollection.Create(ThrashEngine.Run, ThrashEngine.Run.MinLCScan, ThrashEngine.Run.MaxLCScan, thrashParameters.ScansToSum, 1, thrashParameters.ProcessMsms);
