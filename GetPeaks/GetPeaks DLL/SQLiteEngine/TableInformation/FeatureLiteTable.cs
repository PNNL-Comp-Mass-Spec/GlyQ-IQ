...
namespace GetPeaks_DLL.SQLiteEngine.TableInformation
{
    public static class FeatureLiteTable
    {
        public static bool CreateFeatrueLiteTableInformation(string fileName, Object databaseLock, List<string> columnList)
        {
