...
namespace DeconX64 //namespace DeconTools.Workflows.Backend.Core
{
        ...
        public virtual ChromPeakSelectorBase CreateChromPeakSelector(TargetedWorkflowParameters workflowParameters)
        {
            ...
            switch (workflowParameters.ChromPeakSelectorMode)
            {
                ...
                case DeconTools.Backend.Globals.PeakSelectorMode.Smart:
                    ...
                    //chromPeakSelector = new SmartChromPeakSelector(smartchrompeakSelectorParameters);//SK
                    chromPeakSelector = new BasicChromPeakSelector(smartchrompeakSelectorParameters);//SK
                    break;
                case DeconTools.Backend.Globals.PeakSelectorMode.SmartUIMF:
                    ...
                    //chromPeakSelector = new SmartChromPeakSelectorUIMF(smartUIMFchrompeakSelectorParameters);//SK
                    chromPeakSelector = new BasicChromPeakSelector(smartUIMFchrompeakSelectorParameters);//SK
