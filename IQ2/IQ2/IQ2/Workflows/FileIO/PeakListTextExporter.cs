...
namespace IQ.Workflows.FileIO
{
    public class PeakListTextExporter : IPeakListExporter
    {
        ...
        public override void WriteOutPeaks(List<Run32.Backend.DTO.MSPeakResult> peakList)
        {
        ...
        private string buildPeakString(Run32.Backend.DTO.MSPeakResult peak)
        {
