...
namespace IQ_X64.Backend.ProcessingTasks.TheorFeatureGenerator
{
    public class JoshTheorFeatureGenerator:ITheorFeatureGenerator
    {
        ...
        public JoshTheorFeatureGenerator(Globals.LabellingType labellingType, double lowPeakCutOff)
        {
            this.LabellingType = labellingType;
            this.LowPeakCutOff = lowPeakCutOff;
        }

        public JoshTheorFeatureGenerator(Globals.LabellingType labellingType, double fractionLabeling, double lowPeakCutOff)
        {
            this.LabellingType = labellingType;
            this.LowPeakCutOff = lowPeakCutOff;
        ...
        public JoshTheorFeatureGenerator(Globals.LabellingType labellingType, double fractionLabeling, double lowPeakCutOff, double molarMixingFraction)
        {
            this.LabellingType = labellingType;
            this.LowPeakCutOff = lowPeakCutOff;
            this.FractionLabeling = fractionLabeling;
