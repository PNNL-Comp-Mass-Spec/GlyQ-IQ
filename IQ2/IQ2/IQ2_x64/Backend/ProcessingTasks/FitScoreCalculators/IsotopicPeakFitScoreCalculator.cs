...
{
    public class IsotopicPeakFitScoreCalculator:TaskIQ
    {
        #region properties
        /// <summary>
        ...
        public IsotopicPeakFitScoreCalculator(Globals.IsotopicProfileType lableType, int numberOfPeaksToLeftForPenalty)
        {
