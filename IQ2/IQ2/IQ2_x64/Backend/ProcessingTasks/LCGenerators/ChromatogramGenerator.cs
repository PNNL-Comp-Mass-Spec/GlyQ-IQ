...
namespace IQ_X64.Backend.ProcessingTasks.LCGenerators
{
    public class ChromatogramGenerator
    {
        ...
        /// <returns></returns>
        public XYData GenerateChromatogram(List<Run64.Backend.DTO.MSPeakResult> msPeakList, int minScan, int maxScan, double targetMZ, double tolerance, Globals.ToleranceUnit toleranceUnit = Globals.ToleranceUnit.PPM)
        {
        ...
        public XYData GenerateChromatogram(List<Run64.Backend.DTO.MSPeakResult> msPeakList, int minScan, int maxScan, double targetMZ, double tolerance, int chromIDToAssign, Globals.ToleranceUnit toleranceUnit = Globals.ToleranceUnit.PPM)
        {
            List<double> targetMZList = new List<double>();
            targetMZList.Add(targetMZ);
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public XYData GenerateChromatogram(List<Run64.Backend.DTO.MSPeakResult> msPeakList, int minScan, int maxScan, List<double> targetMZList, double tolerance, Globals.ToleranceUnit toleranceUnit = Globals.ToleranceUnit.PPM)
        {
        ...
        public XYData GenerateChromatogram(List<Run64.Backend.DTO.MSPeakResult> msPeakList, int minScan, int maxScan, List<double> targetMZList, double tolerance, int chromIDToAssign, Globals.ToleranceUnit toleranceUnit = Globals.ToleranceUnit.PPM)
        {
            ...
            foreach (var targetMZ in targetMZList)
            {
				...
				List<Run64.Backend.DTO.MSPeakResult> tempPeakList = new List<Run64.Backend.DTO.MSPeakResult>();

				for (int i = indexOfLowerScan; i <= indexOfUpperScan; i++)
				{
					Run64.Backend.DTO.MSPeakResult msPeakResult = msPeakList[i];
        ...
        public List<Run64.Backend.DTO.MSPeakResult> GeneratePeakChromatogram(List<Run64.Backend.DTO.MSPeakResult> msPeakList, int minScan, int maxScan, List<double> targetMZList, double toleranceInPPM)
        {
            int scanTolerance = 5;     // TODO:   keep an eye on this
            ...
            List<Run64.Backend.DTO.MSPeakResult> filteredPeakList = new List<Run64.Backend.DTO.MSPeakResult>();
            ...
            List<Run64.Backend.DTO.MSPeakResult> compiledChromPeakList = new List<Run64.Backend.DTO.MSPeakResult>();
            ...
            foreach (var targetMZ in targetMZList)
            {
                ...
                List<Run64.Backend.DTO.MSPeakResult> tempPeakList = filteredPeakList.Where(p => p.MSPeak.XValue >= lowerMZ && p.MSPeak.XValue <= upperMZ).ToList();
            ...
            {
                compiledChromPeakList.Sort(delegate(Run64.Backend.DTO.MSPeakResult peak1, Run64.Backend.DTO.MSPeakResult peak2)
                {
        ...
        [Obsolete("Use the other GeneratePeakChromatogram!")]
        public List<Run64.Backend.DTO.MSPeakResult> GeneratePeakChromatogram(List<Run64.Backend.DTO.MSPeakResult> msPeakList, int minScan, int maxScan, double targetMZ, double toleranceInPPM)
        {
            List<double> targetMZList = new List<double>();
            targetMZList.Add(targetMZ);
        ...
        private XYData getChromDataAndFillInZerosAndAssignChromID(List<Run64.Backend.DTO.MSPeakResult> filteredPeakList, int chromID)
        {
            ...
            {
                Run64.Backend.DTO.MSPeakResult peakResult = filteredPeakList[i];
        ...
        private int getIndexOfClosestScanValue(List<Run64.Backend.DTO.MSPeakResult> peakList, int targetScan, int leftIndex, int rightIndex, int scanTolerance)
        {
