...
namespace IQ_X64.Backend.ProcessingTasks.PeakDetectors
{
    public class ChromPeakDetector:DeconToolsPeakDetectorV2
    {
        ...
        public override Run64.Backend.Core.Peak CreatePeak(double xvalue, float height, float width = 0, float signalToNoise = 0)
        {
