...
namespace IQ_X64.Backend.ProcessingTasks.ChromatogramProcessing
{
    public abstract class ChromatogramCorrelatorBase : TaskIQ
    {
        ...
        {
            if (basePeakChromXYData == null || basePeakChromXYData.Xvalues == null || basePeakChromXYData.Xvalues.Length == 0 || chromPeakXYData.Xvalues.Length == 0 || chromPeakXYData.Xvalues.Length == 1) return null;
            ...
            {
                //this is some sketchy stuff here as we try to wrangle doubles into dictionary keys
