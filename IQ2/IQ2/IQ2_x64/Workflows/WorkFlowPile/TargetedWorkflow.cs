...
namespace IQ_X64.Workflows.WorkFlowPile
{
    public abstract class TargetedWorkflow : WorkflowBase
    {
        ...
        protected void updateChromDataXYValues(Run64.Backend.Data.XYData xydata)
        {
            if (xydata == null)
            {
        ...
        protected void updateMassSpectrumXYValues(Run64.Backend.Data.XYData xydata)
        {
            if (xydata == null)
            {
                //ResetStoredXYData(ChromatogramXYData);
        ...
        protected virtual Run64.Backend.Data.XYData TrimData(Run64.Backend.Data.XYData xyData, double targetVal, double leftTrimAmount, double rightTrimAmount)
        {
        ...
        public virtual void ResetStoredData()
        {
            ...
            if (this.ChromPeaksDetected != null)
            {
        ...
        public void ResetStoredXYData(Run64.Backend.Data.XYData xydata)
        {
            if (xydata != null)
            {
