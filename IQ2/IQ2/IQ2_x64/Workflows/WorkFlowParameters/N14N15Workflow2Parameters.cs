...
namespace IQ_X64.Workflows.WorkFlowParameters
{
    public class N14N15Workflow2Parameters : TargetedWorkflowParameters
    {
        ...
        public N14N15Workflow2Parameters()
        {
            ...
            TargetedFeatureFinderIsotopicProfileTargetType = Globals.IsotopicProfileType.LABELLED;
            TargetedFeatureFinderToleranceInPPM = MSToleranceInPPM;
            ResultType = Globals.ResultType.N14N15_TARGETED_RESULT;
        ...
        public Globals.IsotopicProfileType TargetedFeatureFinderIsotopicProfileTargetType { get; set; }
        ...
        {
            get { return GlobalsWorkFlow.TargetedWorkflowTypes.N14N15Targeted1; }
        }
