...
namespace IQ_X64.Workflows.WorkFlowParameters
{
    public abstract class TargetedWorkflowParameters : WorkflowParameters
    {
        ...
        protected TargetedWorkflowParameters()
        {
            ...
            ChromPeakSelectorMode = Globals.PeakSelectorMode.Smart;
        ...
        /// </summary>
        public Globals.ToleranceUnit ChromGenToleranceUnit { get; set; }
        ...
        public Globals.ChromatogramGeneratorMode ChromGeneratorMode { get; set; }
        ...
        /// 
        /// </summary>
        public Globals.PeakSelectorMode ChromPeakSelectorMode { get; set; }
