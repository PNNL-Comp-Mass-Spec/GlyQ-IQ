...
namespace HammerPeakDetector
{
    class ProbabilityDistribution
    {
        ...
        public List<XYData> FitDistribution(List<XYData> histogram, out double[] coefficents, out double areaUnderCurve, out List<XYData> modeledPeakList)
        {
            ...
            List<XYData> clippedFitXyData = CurveFit.Fit_LM(histogram, out fitMetrics, out areaUnderCurve, ref coefficents, out modeledPeakList, numberOfSamples, sampleWidth, ref errorLog, out scanRangeFit, EnumerationCurveType.Gaussian);
