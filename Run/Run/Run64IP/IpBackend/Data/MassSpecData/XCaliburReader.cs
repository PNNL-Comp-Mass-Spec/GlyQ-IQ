...
namespace InformedProteomics.Backend.MassSpecData
{
    public class XCaliburReader: IMassSpecDataReader
    {
        ...
        /// <summary>
        /// run ProteoWizard centroider or not.  False will return the full profile data
        /// </summary>
        public bool runCentroider = false;
        ...
        public IEnumerable<Spectrum> ReadAllSpectra()
        {
            ...
            //for (var scanNum = _minLcScan; scanNum <= _maxLcScan; scanNum++) yield return ReadAverageMassSpectrum(scanNum);
        }
        ...
        /// <param name="scanNum">scan number</param>
        /// <returns>mass spectrum</returns>
        public Spectrum ReadAverageMassSpectrum(int scanNum)//int[]
        {
            int nScansToAverage = 3;
            int scan = 1000;
            ...
            object peakFlags = null;
            var arraySize = 0;
            _msfileReader.GetAveragedMassSpectrum(
                ref scan, //scans to sum?
                nScansToAverage, //how many scans to average
                returnCentroid, //centroid the data false = profile
                ref peakArr, //mass list data
                ref peakFlags, //peak flags?
                ref arraySize);//how mant points
