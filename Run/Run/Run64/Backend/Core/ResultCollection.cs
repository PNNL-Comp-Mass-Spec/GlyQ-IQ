...
namespace Run64.Backend.Core
{
    ...
    public class ResultCollection
    {
        ...
        public ResultCollection(Run run)
        {
            ...
            this.MSPeakResultList = new List<Run64.Backend.DTO.MSPeakResult>();
        ...
        private List<Run64.Backend.DTO.MSPeakResult> mSPeakResultList;
        public List<Run64.Backend.DTO.MSPeakResult> MSPeakResultList
        {
        ...
        public void FillMSPeakResults()
        {
            ...
            {
                PeakCounter++;
                Run64.Backend.DTO.MSPeakResult peakResult = new Run64.Backend.DTO.MSPeakResult(PeakCounter, this.Run.CurrentScanSet.PrimaryScanNumber, peak);
