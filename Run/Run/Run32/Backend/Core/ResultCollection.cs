...
namespace Run32.Backend.Core
{
    ...
    public class ResultCollection
    {
        ...
        public ResultCollection(Run run)
        {
            ...
            this.MSPeakResultList = new List<DTO.MSPeakResult>();
        ...
        private List<DTO.MSPeakResult> mSPeakResultList;
        public List<DTO.MSPeakResult> MSPeakResultList
        {
        ...
        public void FillMSPeakResults()
        {
            ...
            {
                PeakCounter++;
                DTO.MSPeakResult peakResult = new DTO.MSPeakResult(PeakCounter, this.Run.CurrentScanSet.PrimaryScanNumber, peak);
