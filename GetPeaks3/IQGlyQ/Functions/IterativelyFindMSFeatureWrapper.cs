...
namespace IQGlyQ.Functions
{
    public class IterativelyFindMSFeatureWrapper
    {
        ...
        public static IsotopicProfile IterativeFeatureFind(IsotopicProfile targetProfile, Run64.Backend.Data.XYData massSpecXyData, IterativeTFF msfeatureFinder)
        {
