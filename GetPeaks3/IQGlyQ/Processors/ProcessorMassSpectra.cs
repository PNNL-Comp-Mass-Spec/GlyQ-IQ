...
namespace IQGlyQ.Processors
{
    public class ProcessorMassSpectra : BaseProcessor
    {
        ...
        /// <returns></returns>
        public List<ProcessedPeak> Execute(Run64.Backend.Data.XYData spectraRaw, EnumerationMassSpectraProcessing chooseMethod)
        {
        ...
        /// <param name="chooseMethod"></param>
        /// <returns></returns>
        public double ExecuteInterference(IsotopicProfile iso, List<Run64.Backend.Core.Peak> mspeakList)
        {
            double score = 0;
                        ...
                        case EnumerationIsotopicProfileMode.DH:
                            {
                                if (!isoTheoretical.isEstablished)
                                {
                                    ...
                                    //int iteratorRange = 10000 *2000;//10,000,000 = 100*10000
                                    int iteratorRange = 1000;
        ...
        public Run64.Backend.Data.XYData DeconMSGeneratorWrapper(Run runIn, ScanSet lcScanSetSelected)
        {
            Run64.Backend.Data.XYData deconMassSpecta = ProcessingParameters.Engine_msGenerator.GenerateMS(runIn, lcScanSetSelected);
