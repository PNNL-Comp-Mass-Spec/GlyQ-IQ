...
namespace IQGlyQ.Processors
{
    public class ProcessorChromatogram : BaseProcessor
    {
        ...
        /// <returns></returns>
        public List<Run64.Backend.Core.Peak> Execute(Run64.Backend.Data.XYData chromatogramRaw, ScanObject scans, EnumerationChromatogramProcessing chooseMethod)
        {
            ...
            List<PNNLOmics.Data.XYData> omicsRaw = ConvertXYData.DeconXYDataToOmicsXYData(chromatogramRaw);
            ...
            List<Run64.Backend.Core.Peak> deconProcessed = Utiliites.ConvertDeconPeakToPeakForIQ(deconProcessedChrome);
        ...
        /// <param name="chooseMethod"></param>
        /// <returns></returns>
        public List<ProcessedPeak> Execute(Run64.Backend.Data.XYData chromatogramRaw, EnumerationChromatogramProcessing chooseMethod)
        {
        ...
        /// <returns></returns>
        public Run64.Backend.Data.XYData GenerateBufferedChromatogramByPoint(Run runIn, ScanObject scans, double massToExtract)
        {
            ...
            Run64.Backend.Data.XYData deconChromatogram = DeconChromatogramGeneratorWrapper(runIn, massToExtract, bufferedRange);

            if (deconChromatogram == null)
                return null;

            Run64.Backend.Data.XYData clippedChromatogram = deconChromatogram.TrimData(bufferedRange.Start, bufferedRange.Stop);
            ...
            Run64.Backend.Data.XYData clippedChromatogramNew = new Run64.Backend.Data.XYData();
        ...
        public static void CalculateElutionTimes(Run run, ref List<Run64.Backend.Core.Peak> peakList)
        {
            foreach (ChromPeak chromPeak in peakList)
            {
        ...
        {
            Run64.Backend.Data.XYData chromatogramDeconProcessed = ConvertXYData.OmicsXYDataToRunXYData(chromatogramRaw);
        ...
        private static List<ProcessedPeak> ChromPeakDetectorWrapper(List<XYData> chromatogramRaw)
        {
            ...
            //decon code
            List<Run64.Backend.Core.Peak> chromatogramDeconPeaks = ProcessingParameters.Engine_ChromPeakDetector.FindPeaks(chromatogramDeconProcessed);
        ...
        //2
        public static Run64.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, IsotopicProfile theorIsotopicProfile, ScanObject bufferedRange, double chromTollerencePPM, Globals.ToleranceUnit unit, PeakChromatogramGenerator _peakChromGen)
        {
            Run64.Backend.Data.XYData deconChromatogram;
            if (ProcessingParameters.isIMS)
            {
                
                double massToExtract = theorIsotopicProfile.GetMZofMostAbundantPeak();
                //Run64.Backend.Data.XYData imsChromatogram = IMS_XIC(runIn, massToExtract, chromTollerencePPM); deconChromatogram = imsChromatogram;//IMS
        ...
        ///this is pulled out becauise the mass to extract was pulled out and we don't want to rely on the isotope profile 3-21

        ////3
        //public static Run64.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, IsotopicProfile theorIsotopicProfile, double elutionTimeTheor, PeakChromatogramGenerator _peakChromGen)
        //{
        //    Run64.Backend.Data.XYData chromatogram;
        //    if (ProcessingParameters.isIMS)
        //    {

        //        double massToExtract = theorIsotopicProfile.GetMZofMostAbundantPeak();
        //        //Run64.Backend.Data.XYData imsChromatogram = IMS_XIC(runIn, massToExtract, ProcessingParameters.ParametersChromGenerator.ChromToleranceInPPM); chromatogram = imsChromatogram;
        ...
        public static Run64.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, double massToExtract)
        {
            Run64.Backend.Data.XYData deconChromatogram;
            ...
            if (ProcessingParameters.isIMS)
            {
                //Run64.Backend.Data.XYData imsChromatogram = IMS_XIC(runIn, massToExtract, ProcessingParameters.Engine_PeakChromGenerator.Tolerance); deconChromatogram = imsChromatogram;
        ...
        /// <summary>
        /// this is an acceptable Chromatogram generation (3-22-2014)
        /// </summary>
        /// <param name="runIn"></param>
        /// <param name="massToExtract"></param>
        /// <param name="bufferedRange"></param>
        /// <returns></returns>
        public static Run64.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, double massToExtract, ScanObject bufferedRange)
        {
            Run64.Backend.Data.XYData deconChromatogram;
        ...
        //public static Run64.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, IsotopicProfile theorIsotopicProfile, double elutionTimeTheor)
        //{
        //    Run64.Backend.Data.XYData deconChromatogram = DeconChromatogramGeneratorWrapper(runIn, theorIsotopicProfile, elutionTimeTheor, ProcessingParameters.Engine_PeakChromGenerator);
        //    return deconChromatogram;
        //}
        ...
        //private static Run64.Backend.Data.XYData IMS_XIC(Run runIn, double massToExtract, double chromTollerencePPM)
        //{
        ...
        //    Run64.Backend.Data.XYData imsChromatogram = new Run64.Backend.Data.XYData();
