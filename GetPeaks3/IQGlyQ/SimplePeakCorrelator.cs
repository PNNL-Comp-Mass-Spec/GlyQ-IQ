...
namespace IQGlyQ
{
    public class SimplePeakCorrelator : ChromatogramCorrelatorBase
    {
        ...
        //public override ChromCorrelationData CorrelateData(Run run, TargetedResultBase result, int scans)
        {
            ...
            IQ_X64.Backend.ProcessingTasks.Smoothers.SavitzkyGolaySmoother smoother = Smoother;
            ...
            if (loadBasePeak.AreChromDataOK == true && loadBasePeak.IsosPeakListIsOK == true)
            {
                ...
                Run64.Backend.Data.XYData basePeakChromXYData = loadBasePeak.PeakChromXYData[loadBasePeak.IndexMostAbundantPeak];
                Run64.Backend.Data.XYData chromPeakXYData = setupPile[0].PeakChromXYData[setupPile[0].IndexMostAbundantPeak];
        ...
        public ChromCorrelationData CorrelateDataXY(List<PNNLOmics.Data.XYData> data1, List<PNNLOmics.Data.XYData> data2, int startScan, int stopScan)
        {
            ...
            if (data1.Count == data2.Count)
            {
                ...
                //this data is not the same as before
                Run64.Backend.Data.XYData basePeakChromXYData = ConvertXYData.OmicsXYDataToRunXYData(data1);
                Run64.Backend.Data.XYData chromPeakXYData = ConvertXYData.OmicsXYDataToRunXYData(data2);
