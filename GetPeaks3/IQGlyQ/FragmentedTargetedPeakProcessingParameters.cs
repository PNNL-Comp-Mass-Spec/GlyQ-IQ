...
namespace IQGlyQ
{
    public class FragmentedTargetedPeakProcessingParameters
    {
        ...
        public void SetParameters(string processingParametersParameterFile)
        {
            ...
            {
                Console.WriteLine("Missing Parameters in FragmentedTargetedPeakProcessingParameters, File name " + processingParametersParameterFile + " should have 18 parameters");
                Console.ReadKey();
            }
