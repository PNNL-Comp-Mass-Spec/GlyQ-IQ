...
namespace IQGlyQ
{
    ...
    public class FragmentedTargetedWorkflowParametersIQ : TargetedWorkflowParameters
    {
        ...
        /// </summary>
        public Run64.Backend.Globals.LabellingType IsotopeProfileType { get; set; }

        /// <summary>
        /// sets which type of isotope profile to use... Either a labeled profile or unlabeled profile
        /// </summary>
        public Run64.Backend.Globals.IsotopicProfileType LabelingTypeSwitch { get; set; }
   ...
   //     public int NumberOfPeaksToLeftForPenalty { get; set; }
        ...
        {
            //DH labeling
            IsotopeProfileType = Run64.Backend.Globals.LabellingType.Deuterium;//default
            //IsotopeProfileType = DeconTools.Backend.Globals.LabellingType.NONE;
            LabelingTypeSwitch = Run64.Backend.Globals.IsotopicProfileType.LABELLED;//default
