                ...
                case EnumerationDataset.Diabetes:
                    {
                        switch (isPic)
                        {
                            ...
                            case EnumerationIsPic.IsNotPic:
                                {
                                    peaksTestFile = @"E:\ScottK\GetPeaks_Data\Diabetes_LC\Gly09_Velos3_Jaguar_230nL30_C14_DB10_30uL1X_31Dec12_peaks.txt";
                                    peaksTestFile = @"S:\Gly09_Velos3_Jaguar_230nL30_C14_DB10_30uL1X_31Dec12_peaks.txt";
                                    pathFragmentParameters = @"E:\ScottK\IQ\RunFiles\FragmentedTargetedWorkflowParameters_Velos_DH.txt";

                                    //home
                                    testFile = @"E:\ScottK\GetPeaks_Data\Diabetes_LC\Gly09_Velos3_Jaguar_230nL30_C14_DB10_30uL1X_31Dec12.raw";

                                    //work ram disk
                                    //testFile = @"Y:\ScottK\GetPeaks_Data\Diabetes_LC\Gly09_Velos3_Jaguar_230nL30_C14_DB10_30uL1X_31Dec12.raw";
                                }
                                break;
                        }
                    }
