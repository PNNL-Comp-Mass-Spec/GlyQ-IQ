...
namespace IQGlyQ.UnitTesting
{
    ...
    class ModuleTesting
    {
        ...
        public void CreateCorrelationObjectAndtestConstancty()
        {
            ...
            Run64.Backend.Data.XYData deconBufferedChromatogram = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, xValue, ScanBoundsInfoMaxMin);
            ...
            //Run64.Backend.Data.XYData upfrontEIC = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, possibleFragmentTarget.TheorIsotopicProfile, possibleFragmentTarget.ElutionTimeTheor);
            ...
            Run64.Backend.Data.XYData upfrontEIC = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, massToExtract);
        ...
        public void TestChromatogram()
        {
            ...
            ChromPeakAnalyzer ChromPeakAnalyzer = new IQ_X64.Workflows.Core.ChromPeakSelection.ChromPeakAnalyzer(_workflowParameters);
            ...
            //TEST CODE
            Run64.Backend.Data.XYData unWrappedDecon = _workflowParameters.LCParameters.Engine_PeakChromGenerator.GenerateChromatogram(runIn, result.Target.TheorIsotopicProfile, result.Target.ElutionTimeTheor);
            ...
            //decon
            IQ_X64.Backend.ProcessingTasks.Smoothers.SavitzkyGolaySmoother ChromSmootherDecon =
        ...
        public void TestChromatogramPeaks()
        {
            ...
            IQ_X64.Backend.ProcessingTasks.Smoothers.SavitzkyGolaySmoother ChromSmoother = new SavitzkyGolaySmoother(_workflowParameters.LCParameters.ParametersSavitskyGolay.PointsForSmoothing,_workflowParameters.LCParameters.ParametersSavitskyGolay.PolynomialOrder,_workflowParameters.LCParameters.ParametersSavitskyGolay.AllowNegativeValues);
        ...
        //    {
        //        ScanSet scanSet = runIn.ScanSetCollection.ScanSetList[i];
        //        Run64.Backend.Data.XYData deconMassSpecta = msParameters.Engine_msGenerator.GenerateMS(runIn, scanSet);
        //        //int scan = i;
        //        //scan = 135;
        ...
        public void TestProcessorLcAt2Levels()
        {
            ...
            Run64.Backend.Data.XYData bufferedDeconChromatogram = _lcProcessor.GenerateBufferedChromatogramByPoint(runIn, targetResult.ScanBoundsInfo, mass);
            ...
            Run64.Backend.Data.XYData deconChromatogram = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, mass, targetResult.ScanBoundsInfo);
        ...
        public void TestProcessorLc()
        {
            ...
            Run64.Backend.Data.XYData deconChromatogram = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, mass, ScanBoundsInfoMaxMin);
            ...
            Run64.Backend.Data.XYData deconChromatogramTopPeak = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, targetResult.Primary_Target.TheorIsotopicProfile, targetResult.ScanBoundsInfo, chromTollerence, Globals.ToleranceUnit.PPM, _workflowParameters.LCParameters.Engine_PeakChromGenerator);
            ...
            Run64.Backend.Data.XYData deconChromatogramTopN = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, targetResult.Primary_Target.TheorIsotopicProfile, targetResult.ScanBoundsInfo, chromTollerence, Globals.ToleranceUnit.PPM, _workflowParameters.LCParameters.Engine_PeakChromGenerator);
            ...
            Run64.Backend.Data.XYData deconChromatogramTop1 = ProcessorChromatogram.DeconChromatogramGeneratorWrapper(runIn, targetResult.Primary_Target.TheorIsotopicProfile, targetResult.ScanBoundsInfo, chromTollerence, Globals.ToleranceUnit.PPM, _workflowParameters.LCParameters.Engine_PeakChromGenerator);
            ...
            Run64.Backend.Data.XYData deconBufferedChromatogramPoint = _lcProcessor.GenerateBufferedChromatogramByPoint(runIn, targetResult.ScanBoundsInfo, mass);
            ...
            Run64.Backend.Data.XYData deconBufferedChromatogram = _lcProcessor.GenerateBufferedChromatogramByPoint(runIn, targetResult.ScanBoundsInfo, mass);
           ...
           // Assert.AreEqual(fullEIC.Count, 70);
            ...
            for (int i = 0; i < iterator; i++)
            {
                Run64.Backend.Data.XYData deconBufferedChromatogramInfinity = _lcProcessor.GenerateBufferedChromatogramByPoint(runIn, targetResult.ScanBoundsInfo, mass);//_workflowParameters.LCParameters.ParametersChromGenerator.ChromToleranceInPPM
        ...
        public void TestSmoothers()
        {
            ...
            Run64.Backend.Data.XYData smoothedResultsPureDecon = deconSmoother.Smooth(iQresult.IqResultDetail.MassSpectrum);
            ...
            {
                Run64.Backend.Data.XYData chromatogramDeconProcessedInfinity = deconSmoother.Smooth(iQresult.IqResultDetail.MassSpectrum);
            ...
            {
                Run64.Backend.Data.XYData chromatogramDeconProcessed = ConvertXYData.OmicsXYDataToDeconXYData(convertedMassSpectrum);
                Run64.Backend.Data.XYData chromatogramDeconProcessedInfinity = deconSmoother.Smooth(chromatogramDeconProcessed);
