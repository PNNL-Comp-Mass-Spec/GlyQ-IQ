...
namespace GetPeaksDllLite.Functions
{
    public static class ConvertXYData
    {
        ...
        /// <param name="runGo">Run</param>
        /// <param name="newData">Omics List of XYData</param>
        public static List<PNNLOmics.Data.XYData> DeconXYDataToOmicsXYData(Run64.Backend.Data.XYData deconData)
        {
            if (deconData == null)
                return null;
        ...
        {
            Run64.Backend.Data.XYData createData = new Run64.Backend.Data.XYData();
        ...
        public static Run64.Backend.Data.XYData OmicsXYDataToDeconXYData(List<PNNLOmics.Data.XYData> existingData)
        {
            Run64.Backend.Data.XYData createData = new Run64.Backend.Data.XYData();
            double[] tempXvalues = new double[existingData.Count];
            double[] tempYValues = new double[existingData.Count];
        ...
        public static Run64.Backend.Data.XYData OmicsXYDataToRunXYData(List<PNNLOmics.Data.XYData> existingData)
        {
            Run64.Backend.Data.XYData createData = new Run64.Backend.Data.XYData();
            double[] tempXvalues = new double[existingData.Count];
            double[] tempYValues = new double[existingData.Count];
        ...
        public static Run64.Backend.Data.XYData OmicsProcessedPeakToRunXYData(List<ProcessedPeak> existingData)
        {
            Run64.Backend.Data.XYData createData = new Run64.Backend.Data.XYData();
            double[] tempXvalues = new double[existingData.Count];
            double[] tempYValues = new double[existingData.Count];
