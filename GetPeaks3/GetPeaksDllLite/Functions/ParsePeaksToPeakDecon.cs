...
namespace GetPeaksDllLite.Functions
{
    ...
    {
        public void Parse(List<string> stringList, DeliminatorOfString textDeliminator, out List<PeakDecon> outputPeakList, out string columnHeadders)
        {
            int startline = 0;
        ...
        public void ParseLite(List<string> stringList, DeliminatorOfString textDeliminator, out List<PeakDeconLite> outputPeakList, out string columnHeadders)
        {
            int startline = 1;
        ...
        public void ParseMass(List<string> stringList, DeliminatorOfString textDeliminator, out List<long> outputMassList, out string columnHeadders)
        {
            int startline = 1;
