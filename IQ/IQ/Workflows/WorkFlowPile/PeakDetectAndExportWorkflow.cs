...
namespace IQ.Workflows.WorkFlowPile
{
    public class PeakDetectAndExportWorkflow : WorkflowBase
    {
        ...
        public override void InitializeWorkflow()
        {
            ...
            _ms2PeakDetectorForCentroidedData = new DeconToolsPeakDetectorV2(0, 0, Globals.PeakFitType.QUADRATIC, true);
            _ms2PeakDetectorForCentroidedData.RawDataType = Globals.RawDataType.Centroided;
