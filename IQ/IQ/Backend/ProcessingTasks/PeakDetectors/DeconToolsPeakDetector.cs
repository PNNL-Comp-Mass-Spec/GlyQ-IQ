...
using IQ.Backend.Parameters;
using Run32.Backend;
using Run32.Backend.Core;
using Run32.Backend.Data;

namespace IQ.Backend.ProcessingTasks.PeakDetectors
{
    public class DeconToolsPeakDetector : PeakDetector
    {
        ...
        private List<Run32.Backend.Core.Peak> ConvertDeconEnginePeakList(DeconToolsV2.Peaks.clsPeak[] peaklist)
        {
