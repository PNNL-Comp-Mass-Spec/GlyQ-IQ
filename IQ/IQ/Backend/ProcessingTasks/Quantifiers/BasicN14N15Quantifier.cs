...
namespace IQ.Backend.ProcessingTasks.Quantifiers
{
    ...
    public class BasicN14N15Quantifier : N14N15Quantifier
    {
        ...
        public BasicN14N15Quantifier(double msToleranceInPPM)
        {
            ...
            this.RatioType = GlobalsWorkFlow.RatioType.ISO1_OVER_ISO2;
        }

        public BasicN14N15Quantifier(double msToleranceInPPM, GlobalsWorkFlow.RatioType ratioType)
       ...
       double backgroundIntensity)
                    ...
                    out double ratio, out double ratioContribForIso1, out double ratioContribForIso2)
        {
            ...
            {
                case GlobalsWorkFlow.RatioType.ISO1_OVER_ISO2:
                    ratio = correctedIso1SummedIntens / correctedIso2SummedIntens;
                    break;
                case GlobalsWorkFlow.RatioType.ISO2_OVER_ISO1:
    ...
    double backgroundIntensity)
        {
            ...
            int indexOfStartingPoint = MathUtils.BinarySearchWithTolerance(xvals, leftMostMZ, 0, xvals.Length - 1, 0.1);
