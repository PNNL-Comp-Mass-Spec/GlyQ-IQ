...
namespace DivideTargetsLibrary.Parameters
{
	public class HPCPrepParameters
	{
		...
		/// <summary>
		/// should we execute the delete after
		/// </summary>
		...
		/// <summary>
		/// Library size for divide targets and HPC run = piece count
		/// </summary>
		...
		public HPCPrepParameters()
		{
			...
			Console.WriteLine("DivideTargetLibraryX86");
			cores = 800;//cpu cores to run on 
