...
using ScanCentric = YAFMS_DB.GetPeaks.ScanCentric;
    ...
    public class YAFMS_DB_UnitTestsIQ
    {
        ...
        public void CycleThroughMS1Test()
        {
            ...
            for (int i = 0; i < scanLevelsWithTandem.Count; i++)
            {
                ...
                PrecursorInfo precursor = precursorMetaData[scanLevelsWithTandem[i]];
        ...
        public void TestMassSpecGeneration()
        {
            ...
            Run32.Backend.Data.XYData massSpectrum = _msProcessor.DeconMSGeneratorWrapper(runIn, iQresult.LCScanSetSelected);
            ...
            Run32.Backend.Data.XYData massSpectrum2 = _msProcessor.DeconMSGeneratorWrapper(runIn, iQresult.LCScanSetSelected);
