...
using IQ.Backend.ProcessingTasks.Quantifiers;
using PNNLOmics.Data;
using Run32.Backend.Core;

namespace IQGlyQ
{
    public class BasicDeuteratedQuantifier : O16O18QuantifierBase
    {
        #region Constructors
        public BasicDeuteratedQuantifier()
        {
            MinIntensity = 1;
            LabelingEfficiency = 1;
        }

        public BasicDeuteratedQuantifier(double minIntensity, double labelingEfficiency)
        {
            MinIntensity = minIntensity;
            LabelingEfficiency = labelingEfficiency;
        }
        ...
        public override double GetRatio(IsotopicProfile isotopicProfile)
        {
            ...
            double ratio = CalculateRatio(MinIntensity);
            
            return ratio;
        }


        //1.  PopulateValues  //PopulateValues(isotopicProfile, theoreticalIso);
        //2.  CalculateDandH  //CalculateDandH(labelingEfficiency);
        //3.  Set Min Ratio  //SetMinIntensity(minIntensity);
        //3.  Calculate Ratio  //GetRatio(IsotopicProfile isotopicProfile)
        ...
        public double CalculateRatio(double minIntensity)
        {
            
            double ratio = -1;

            List<double> DHratio = new List<double>();
        ...
        //    intensityTheoryI0 = getI0Intensity(theorIso);
        //    intensityTheoryI2 = getI2Intensity(theorIso);
        //    intensityTheoryI4 = getI4Intensity(theorIso);

            
        //    if (intensityExpI4 == 0)
        //    {
        //        adjustedI4Intensity = intensityExpI4;
        //    }
        //    else
        //    {
        ...
        //        adjustedI4Intensity = intensityExpI4 - (intensityTheoryI4 / intensityTheoryI0 * intensityExpI0);

        //        if (intensityExpI2 > 0)
        //        {
        //            adjustedI4Intensity = adjustedI4Intensity - (intensityTheoryI2 / intensityTheoryI0) * (intensityExpI2 - intensityTheoryI2 / intensityTheoryI0 * intensityExpI0) + 0.5 * (intensityExpI2 - intensityTheoryI2 / intensityTheoryI0 * intensityExpI0);
        //        }
        //        else
        //        {
        ...
        //    return intensityExpI0 / adjustedI4Intensity;
