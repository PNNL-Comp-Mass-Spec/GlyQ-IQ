...
//    //{
//    //}
//    //http://rsbweb.nih.gov/ij/developer/source/ij/measure/CurveFitter.java.html
//      //CurveFitter.java    
...
//            public int STRAIGHT_LINE = 0;
//            public int POLY2 = 1;
//            public int POLY3 = 2;
//            public int POLY4 = 3;
//            public int EXPONENTIAL = 4;
//            public int POWER = 5;
//            public int LOG = 6;
//            public int RODBARD = 7;
//            public int GAMMA_VARIATE = 8;
//            public int LOG2 = 9;
//            public int RODBARD2 = 10;
//            public int EXP_WITH_OFFSET = 11;
//            public int GAUSSIAN = 12;
//            public int EXP_RECOVERY = 13;
//            public int INV_RODBARD = 14;
//            public int EXP_REGRESSION = 15;
//            public int POWER_REGRESSION = 16;
//            public int POLY5 = 17;
//            public int POLY6 = 18;
//            public int POLY7 = 19;
//            public int POLY8 = 20;

//            public static List<int> sortedTypes {get;set;}
//            public static List<string> fList { get; set; }
//            public static List<string> fitList { get; set; }
...
//            private static int CUSTOM = 100;   // user function defined in macro or plugin
//            private static int GAUSSIAN_INTERNAL = 101;   // Gaussian with separate offset & multiplier
//            private static int RODBARD_INTERNAL = 102;    // Rodbard with separate offset & multiplier
...
//            private static Hashtable<String, Int32> namesTable; // converts fitList String into number
...
//                sortedTypes = new List<int>();
//                sortedTypes.Add(STRAIGHT_LINE);
//                sortedTypes.Add(POLY2);
//                sortedTypes.Add(POLY3);
//                sortedTypes.Add(POLY4);
//                sortedTypes.Add(POLY5);
//                sortedTypes.Add(POLY6);
//                sortedTypes.Add(POLY7);
//                sortedTypes.Add(POLY8);
//                sortedTypes.Add(POWER);
//                sortedTypes.Add(POWER_REGRESSION);
//                sortedTypes.Add(EXPONENTIAL);
//                sortedTypes.Add(EXP_REGRESSION);
//                sortedTypes.Add(EXP_WITH_OFFSET);
//                sortedTypes.Add(EXP_RECOVERY);
//                sortedTypes.Add(LOG);
//                sortedTypes.Add(LOG2);
//                sortedTypes.Add(RODBARD);
//                sortedTypes.Add(RODBARD2);
//                sortedTypes.Add(INV_RODBARD);
//                sortedTypes.Add(GAUSSIAN);
//                sortedTypes.Add(GAMMA_VARIATE);

//            /** Names of the built-in fit functions */
//                fitList = new List<string>();
//                fitList.Add("Straight Line");
//                fitList.Add("2nd Degree Polynomial");
//                fitList.Add("3rd Degree Polynomial");
//                fitList.Add("4th Degree Polynomial");
//                fitList.Add("Exponential");
//                fitList.Add("Power");
//                fitList.Add("Log");
//                fitList.Add("Rodbard");
//                fitList.Add("Gamma Variate");
//                fitList.Add("y = a+b*ln(x-c)");
//                fitList.Add("Rodbard (NIH Image)");
//                fitList.Add("Exponential with Offset");
//                fitList.Add("Gaussian");
//                fitList.Add("Exponential Recovery");
//                fitList.Add("Inverse Rodbard");
//                fitList.Add("Exponential (linear regression)");
//                fitList.Add("Power (linear regression)");
//                fitList.Add("5th Degree Polynomial");
//                fitList.Add("6th Degree Polynomial");
//                fitList.Add("7th Degree Polynomial");
//                fitList.Add("8th Degree Polynomial");

//                /** Equations of the built-in fit functions */
//                fList = new List<string>();
//                fList.Add("y = a+bx");                                  //STRAIGHT_LINE,POLY2
//                fList.Add("y = a+bx+cx^2");
//                fList.Add("y = a+bx+cx^2+dx^3");
//                fList.Add("y = a+bx+cx^2+dx^3+ex^4");
//                fList.Add("y = a*exp(bx)");
//                fList.Add("y = a*x^b");
//                fList.Add("y = a*ln(bx)");                              //EXPONENTIAL,POWER,LOG
//                fList.Add("y = d+(a-d)/(1+(x/c)^b)");
//                fList.Add("y = b*(x-a)^c*exp(-(x-a)/d)");               //RODBARD,GAMMA_VARIATE
//                fList.Add("y = a+b*ln(x-c)");
//                fList.Add("x = d+(a-d)/(1+(y/c)^b)");                   //LOG2,RODBARD2
//                fList.Add("y = a*exp(-bx) + c");
//                fList.Add("y = a + (b-a)*exp(-(x-c)*(x-c)/(2*d*d))");   //EXP_WITH_OFFSET,GAUSSIAN
//                fList.Add("y = a*(1-exp(-b*x)) + c");
//                fList.Add("y = c*((x-a)/(d-x))^(1/b)");                 //EXP_RECOVERY, INV_RODBARD
//                fList.Add("y = a*exp(bx)");
//                fList.Add("y = a*x^b");                //EXP_REGRESSION, POWER_REGRESSION
//                fList.Add("y = a+bx+cx^2+dx^3+ex^4+fx^5");
//                fList.Add("y = a+bx+cx^2+dx^3+ex^4+fx^5+gx^6");
//                fList.Add("y = a+bx+cx^2+dx^3+ex^4+fx^5+gx^6+hx^7");
//                fList.Add("y = a+bx+cx^2+dx^3+ex^4+fx^5+gx^6+hx^7+ix^8");
//            }
...
//    if (!(fitType>=STRAIGHT_LINE && fitType<fitList.Count || fitType==CUSTOM))
...
//     *  getParams() to access the result.
//     */
//    public int doCustomFit(String equation, double[] initialParams, bool showSettings) {
//    customFormula = null;
//    customParamCount = 0;
...
//    double[] initialParams, double[] initialParamVariations, bool showSettings) {
...
//        {
//            String[] l = new String[fitList.Count];
...
//    if (namesTable == null) {
//    Hashtable<String,Int32> h = new Hashtable<String,Int32>();
//    for (int i=0; i<fitList.Count; i++)
//    h.put(fitList[i], new Int32(i));
//    namesTable = h;
//    }
//    Int32 i = (Int32)namesTable.get(fitName);
...
//     */
//    public double userFunction(double[] parameters  , double dummy) 
//    {
...
//            {
//                double fValue = f(parameters,xData[i]);
...
//        minimizerParamsToFullParams(parameters, true);
//        doRegression(parameters);
//        sumResidualsSqr = fullParamsToMinimizerParams(parameters);
//    }
...
//     */
//    private void minimizerParamsToFullParams(double[] parameters, bool forRegression) 
//    {
...
//            if (offsetParam >= 0)
//                offset = parameters[i];
//            sumResidualsSqr = parameters[numParams-numRegressionParams];    // sum of squared residuals has been calculated already
//            parameters[numParams] = sumResidualsSqr;                        // ... and is now stored in its new (proper) place
//        }
...
//                parameters[i] = factor;
//            else
//                parameters[i] = parameters[iM--];
//        }
//        parameters[numParams] = sumResidualsSqr;
//    }
