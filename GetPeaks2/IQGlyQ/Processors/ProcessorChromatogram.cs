...
namespace IQGlyQ.Processors
{
    public class ProcessorChromatogram : BaseProcessor
    {
        ...
        /// <returns></returns>
        public List<Run32.Backend.Core.Peak> Execute(Run32.Backend.Data.XYData chromatogramRaw, ScanObject scans, EnumerationChromatogramProcessing chooseMethod)
        {
            ...
            List<Run32.Backend.Core.Peak> deconProcessed = Utiliites.ConvertDeconPeakToPeakForIQ(deconProcessedChrome);
        ...
        /// <param name="chooseMethod"></param>
        /// <returns></returns>
        public List<ProcessedPeak> Execute(Run32.Backend.Data.XYData chromatogramRaw, EnumerationChromatogramProcessing chooseMethod)
        {
        ...
        /// <returns></returns>
        public Run32.Backend.Data.XYData GenerateBufferedChromatogramByPoint(Run runIn, ScanObject scans, double massToExtract)
        {
            ...
            Run32.Backend.Data.XYData deconChromatogram = DeconChromatogramGeneratorWrapper(runIn, massToExtract, bufferedRange);

            if (deconChromatogram == null)
                return null;

            Run32.Backend.Data.XYData clippedChromatogram = deconChromatogram.TrimData(bufferedRange.Start, bufferedRange.Stop);
            ...
            Run32.Backend.Data.XYData clippedChromatogramNew = new Run32.Backend.Data.XYData();
        ...
        public static void CalculateElutionTimes(Run run, ref List<Run32.Backend.Core.Peak> peakList)
        {
            foreach (ChromPeak chromPeak in peakList)
            {
        ...
        {
            Run32.Backend.Data.XYData chromatogramDeconProcessed = ConvertXYData.OmicsXYDataToRunXYData(chromatogramRaw);
        ...
        private static List<ProcessedPeak> ChromPeakDetectorWrapper(List<XYData> chromatogramRaw)
        {
            ...
            //decon code
            List<Run32.Backend.Core.Peak> chromatogramDeconPeaks = ProcessingParameters.Engine_ChromPeakDetector.FindPeaks(chromatogramDeconProcessed);
        ...
        //2
        public static Run32.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, IsotopicProfile theorIsotopicProfile, ScanObject bufferedRange, double chromTollerencePPM, Globals.ToleranceUnit unit, PeakChromatogramGenerator _peakChromGen)
        {
            Run32.Backend.Data.XYData deconChromatogram;
            if (ProcessingParameters.isIMS)
            {
                
                double massToExtract = theorIsotopicProfile.GetMZofMostAbundantPeak();
                //Run32.Backend.Data.XYData imsChromatogram = IMS_XIC(runIn, massToExtract, chromTollerencePPM); deconChromatogram = imsChromatogram;//IMS
        ...
        ////3
        //public static Run32.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, IsotopicProfile theorIsotopicProfile, double elutionTimeTheor, PeakChromatogramGenerator _peakChromGen)
        //{
        //    Run32.Backend.Data.XYData chromatogram;
        //    if (ProcessingParameters.isIMS)
        //    {

        //        double massToExtract = theorIsotopicProfile.GetMZofMostAbundantPeak();
        //        //Run32.Backend.Data.XYData imsChromatogram = IMS_XIC(runIn, massToExtract, ProcessingParameters.ParametersChromGenerator.ChromToleranceInPPM); chromatogram = imsChromatogram;
        ...
        public static Run32.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, double massToExtract)
        {
            Run32.Backend.Data.XYData deconChromatogram;
            ...
            if (ProcessingParameters.isIMS)
            {
                //Run32.Backend.Data.XYData imsChromatogram = IMS_XIC(runIn, massToExtract, ProcessingParameters.Engine_PeakChromGenerator.Tolerance); deconChromatogram = imsChromatogram;
        ...
        /// <returns></returns>
        public static Run32.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, double massToExtract, ScanObject bufferedRange)
        {
            Run32.Backend.Data.XYData deconChromatogram;
        ...
        //public static Run32.Backend.Data.XYData DeconChromatogramGeneratorWrapper(Run runIn, IsotopicProfile theorIsotopicProfile, double elutionTimeTheor)
        //{
        //    Run32.Backend.Data.XYData deconChromatogram = DeconChromatogramGeneratorWrapper(runIn, theorIsotopicProfile, elutionTimeTheor, ProcessingParameters.Engine_PeakChromGenerator);
        //    return deconChromatogram;
        //}
        ...
        //private static Run32.Backend.Data.XYData IMS_XIC(Run runIn, double massToExtract, double chromTollerencePPM)
        //{
        ...
        //    Run32.Backend.Data.XYData imsChromatogram = new Run32.Backend.Data.XYData();
