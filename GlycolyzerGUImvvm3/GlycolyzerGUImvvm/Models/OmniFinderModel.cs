...
{
    public class OmniFinderModel : ObservableObject
    {
        //OmniFinder Mass
        private Double omniFinderMass_String = 0.0;
        ...
        //User Number
        private int parameterNumberOfUserUnits_Int = 0;
        ...
        //OmniFinder Mass
        public Double OmniFinderMass_String
        {
            get { return omniFinderMass_String; }
            set { if (value != omniFinderMass_String) { omniFinderMass_String = value; OnPropertyChanged("omniFinderMass_String"); } }
        }
        ...
        //User Number
        public int ParameterNumberOfUserUnits_Int
        {
            get { return parameterNumberOfUserUnits_Int; }
            set { if (value != parameterNumberOfUserUnits_Int) { parameterNumberOfUserUnits_Int = (int)value; OnPropertyChanged("parameterNumberOfUserUnits_Int"); } }
        }
