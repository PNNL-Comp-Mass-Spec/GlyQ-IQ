...
namespace Sipper
{
    public class SipperResultFromTextImporter : TargetedResultFromTextImporter
    {
        ...
        private string[] _RSquaredForRatio = { "RSquared",  "Fragment_LM_R2"};
        ...
        private string[] _fitScoreLabeledHeaders = {"FitScoreLabeled", "FitScoreLabelled", "IsoFit"};
        private string[] _contigScoreHeaders = {"ContigScore"};

        private string[] _MonoMzHeaders = { "MZObs" };
        private string[] _MonoHeaders = { "MonoMassObs" };
        private string[] _ChargeStateHeaders = { "ChargeState" };
        ...
        protected override TargetedResultDTO ConvertTextToDataObject(List<string> processedData)
        {
            ...
            result.MonoMZ = ParseDoubleField(LookupData(processedData, _MonoMzHeaders));
            result.MonoMass = ParseDoubleField(LookupData(processedData, _MonoHeaders));
            result.ChargeState = ParseIntField(LookupData(processedData, _ChargeStateHeaders));
