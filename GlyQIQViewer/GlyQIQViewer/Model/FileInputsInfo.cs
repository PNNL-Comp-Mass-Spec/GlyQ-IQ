...
namespace Sipper.Model
{
    public class FileInputsInfo
    {
        ...
        public FileInputsInfo(string datasetPath, string parameterFilePath, string targetsFilePath, string msWorkflowParameterFilePath)
            : this()
        {
            ...
            MsWorkflowParameterFilePath = msWorkflowParameterFilePath;
        }
        #endregion
        ...
        public string MsWorkflowParameterFilePath { get; set; }
